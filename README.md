...
| plan | `/plan` | 기능 설명을 받아 progress/{feature-id}.json에 feature·Acceptance Criteria를 생성 |
...
| evaluator-functional-frontend | 살아있는 frontend dev server에 Playwright DOM·network 기반으로 acceptance criteria 1:1 검증하고 PASS 항목을 재실행용 spec 파일로 저장 (평가 체인 1단계, stack=frontend) |
