...
argument-hint: <feature-id (생략 시 planned feature 자동 선택)>
allowed-tools:
  - Read
  - Write
  - Edit
...
```
/implement                    # planned feature 자동 선택
/implement react-migration    # 특정 feature id 지정
```
