...
현재 세션의 대화 히스토리에서 다음 두 가지를 모두 수집한다:
1. **교정**: 사용자가 영어로 쓴 문장의 교정 내용
2. **표현 팁**: 사용자가 한국어로 쓴 내용에 대해 제공한 "You could say:" 영어 표현
...
세션 중 영어 교정 또는 표현 팁이 쌓이면 마무리 시 기록을 제안한다.
한국어로만 작성한 세션이라도 "You could say:" 표현 팁이 3개 이상이면 제안한다.
